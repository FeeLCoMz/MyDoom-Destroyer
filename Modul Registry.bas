Attribute VB_Name = "ModulRegistry"
Option Explicit
...
' *** Set nilai dibawah ke True jika ingin mendebug kesalahan pada operasi Regisry ***
...
Select Case lErrorCode
       Case 1009, 1015
            ErrorMsg = "Database Registry telah rusak"
       Case 2, 1010
            ErrorMsg = "Nama Key salah atau tidak ada"
       Case 1011
            ErrorMsg = "Tidak bisa membuka Key"
       Case 4, 1012
            ErrorMsg = "Tidak bisa membaca Key"
       Case 5
            ErrorMsg = "Akses ditolak!"
       Case 1013
            ErrorMsg = "Tidak bisa menulis Key"
       Case 8, 14
            ErrorMsg = "Memory tidak mencukupi"
       Case 87
            ErrorMsg = "Parameter salah"
       Case 234
            ErrorMsg = "Data telah melebihi kapasitas Buffer"
       Case Else
            ErrorMsg = "Kode Kesalahan:  " & Str$(lErrorCode)
End Select
